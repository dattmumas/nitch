  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="/scripts" title="Scripts">
                Write your scripts using best in class project based text editor.
              </ListItem>
              <ListItem href="/analytics" title="Analytics">
                Best in class analytics sweet for up to date performance on all your content.
              </ListItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>For Advertisers</NavigationMenuTrigger>
          <NavigationMenuContent>
